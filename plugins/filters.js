...
const array = ['Ayin','Ayinu','Bgm','Bot','Bye','Da','Good night','Hello','Hi','Neymar','Pm','Sed','alive','assist','ban','bgm','bot','converting','fake','fork','fuck','music','myre','njan','number','oombi','para','poda','raganork','remove','reply','sed','subscribe','Z aayi','Polikkam','Kollamo','Sike','Ashil','Bgm','Andi','Pinnem vanno','habibbi','Bot','Vijay','Vannu','ayn','Ingane','Don','Friend','Jaichu','umma','xxxtentation']
array.map( async (a) => {
